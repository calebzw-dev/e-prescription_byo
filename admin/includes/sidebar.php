                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link  
                            <?= ($page == 'products-create.php.php') || ($page == 'products.php') ? 'collapse active':'collapsed'; ?>"
                            href="#" 
                            data-bs-toggle="collapse" 
                            ...
                            <a class="nav-link 
                            <?= ($page == 'customers-create.php.php') || ($page == 'customers.php') ? 'collapse active':'collapsed'; ?>" 
                            href="#" 
                            data-bs-toggle="collapse" 
                            ...
                            <a class="nav-link
                            <?= ($page == 'admins-create.php.php') || ($page == 'admins.php') ? 'collapse active':'collapsed'; ?>" 
                            href="#" 
                            data-bs-toggle="collapse" 
