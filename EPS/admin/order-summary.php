  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <button href="orders.php" class="btn btn-secondary">Close</button>
...
<div class="container-fluid px-4">
        <div class="row">
               <div class="col-md-12">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center;" colspan="2">
                                   <h4 style="font-size: 23px; line-height: 30px; margin:2px; padding: 0;">Caleb Company</h4>
                                   <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">#747, Tuli street, 3rd cross, Mqabuko Heights, Bulawayo</p>
                                   <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">company CALEB pvt ltd</p>
                                </td>
                         </tr>
                         <tr>
                                <td>
                         ...
                         <tr>
                                <td align="end">
                                   ...
                                   <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Invoice Name: <?=$invoiceNo; ?> </p>
                                   <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Invoice Date: <?= date('d M Y'); ?></p>
                                   <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Address: Caleb road, Mqabuko Heights, Bulawayo </p>
                                </td>
                         </tr>
                        </tbody>
                        </table>
                    ...
                    {
                        echo '<h5 class="text-center">No Item</h5>';
                    }
                    ?>
                         </div>
                         ...
                         <?php if(isset($_SESSION['productItems'])) : ?>
                            <div class="mt-4 text-end">
                                ...
                                <button type="button" onclick="printMyBillingArea()" class="btn btn-danger">Print</button>
                                <button type="button" class="btn btn-warning px-4 mx-1" onclick="downloadPDF('<?= $_SESSION['invoice_no']; ?>')">
                                Download PDF
                                </button>
                            </div>
                            <?php endif; ?>
