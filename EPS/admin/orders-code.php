...
if(isset($_POST['productIncDec']))
{
    ...
    foreach($_SESSION['productItems'] as $key => $item){
        if($item['product_id'] == $productId){
            ...
            $flag = true;
            $_SESSION['productItems'][$key]['quanttity'] = $quantity;
        }
    }
...
if(isset($_POST['saveCustomerBtn']))
{
    ...
    if($name != '' && $phone != ''){
       ...
       if($result){
        ...
        jsonResponse(422, 'warning', 'Customer Not Found');
    }
}
   ...
   if(!$checkCustomer){
    ...
    if(mysqli_num_rows($checkCustomer) > 0)
    {
        ...
        foreach($sessionProducts as $prodItem){
            ...
            $orderItemQuery = insert('orders_items', $dataOrderItem);
            ...
            $productQtyData = $productQtyData['quantity'] - quantity;
