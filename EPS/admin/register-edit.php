...
<div class="card-header">
                        <h4 class="mb-0">Change password
                            <a href="register-update.php" class="btn btn-danger float-end">Back</a>
                        </h4>
</div>
<div class="card-body">
    <?php alertMessage(); ?>
    ...
    {
        echo '<h5>No id given in prams</h5>';
        return false;
    }
...
<div class="col-md-6 mb-3">
        ...
        <input type="text" name="pname" required value="<?= $adminData['data']['pname']; ?>" class="form-control" />
</div>
    <div class="col-md-6 mb-3">
...
<div class="col-md-6 mb-3">
        ...
        <br/>
        <input type="checkbox" name="receptionist" required <?= $adminData['data']['receptionist'] == true ? 'checked':''; ?> style="width:30px;height:30px;" />
</div>
