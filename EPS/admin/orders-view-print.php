                        ...
                        <tbody>
                         ...
                         <tr>
                                <td>
                                   ...
                                   <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Customer Phone No.: <?=$orderDataRow['phoe'] ?></p>
                         ...
                         <tr>
                                <td align="end">
                                   ...
                                   <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Invoice Name: <?=$orderDataRow['invoice_no']; ?> </p>
