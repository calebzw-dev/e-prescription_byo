...
<div class="card-header">
                        <h4 class="mb-0"> Emergency Pharmacy
                            <a href="emergency.php" class="btn btn-danger float-end">Back</a>
                        </h4>
</div>
<div class="card-body">
    <?php alertMessage(); ?>
...
$db = mysqli_select_db($connection,'pharmacy2');

if(isset($_POST['search']))
{
    $drug_name = $_POST['drug_name'];

    $query = "SELECT * FROM emergency1 where drug_name='$drug_name' ";
